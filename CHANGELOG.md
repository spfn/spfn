...
- **Fix ESM imports in repositories/index.ts**: Add explicit `.js` extension to all repository imports
  - Changed `from './cms-labels.repository'` to `from './cms-labels.repository.js'`
  - Completes ESM migration for all internal imports
  - Fixes "Cannot find module" errors when loading CMS routes
