...
ALTER TABLE "spfn_cms"."label_versions" ADD CONSTRAINT "label_versions_label_id_labels_id_fk" FOREIGN KEY ("label_id") REFERENCES "spfn_cms"."labels"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "cms_label_versions_label_id_idx" ON "spfn_cms"."label_versions" USING btree ("label_id");--> statement-breakpoint
CREATE INDEX "cms_label_versions_status_idx" ON "spfn_cms"."label_versions" USING btree ("status");--> statement-breakpoint
