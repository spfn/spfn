...
describe('Configuration Builders', () =>
{
    ...
    describe('getPoolConfig', () =>
    {
        ...
        it('should throw error for invalid environment variable values', () =>
        {
            ...
            expect(() => getPoolConfig()).toThrow('DB_POOL_MAX');
        });
    ...
    describe('getRetryConfig', () =>
    {
        ...
        it('should throw error for invalid environment variable values', () =>
        {
            ...
            // Should throw error for invalid number
            expect(() => getRetryConfig()).toThrow('DB_RETRY_MAX');
        });
    ...
    describe('buildHealthCheckConfig', () =>
    {
        ...
        it('should throw error for invalid boolean environment variable values', () =>
        {
            ...
            expect(() => buildHealthCheckConfig()).toThrow('DB_HEALTH_CHECK_ENABLED');
        });
        ...
        it('should throw error for invalid number environment variable values', () =>
        {
            ...
            // Should throw error for invalid number
            expect(() => buildHealthCheckConfig()).toThrow('DB_HEALTH_CHECK_INTERVAL');
        });
    });
    ...
    describe('buildMonitoringConfig', () =>
    {
        ...
        it('should throw error for invalid environment variable values', () =>
        {
            ...
            // Should throw error for invalid number
            expect(() => buildMonitoringConfig()).toThrow('DB_MONITORING_SLOW_THRESHOLD');
        });
    });
