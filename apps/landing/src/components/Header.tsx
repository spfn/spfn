                        ...
                        <div className="space-y-2 pb-3 pt-2">
                            {navigation.map((item) => (
                                <a
                                    key={item.name}
                                    href={item.href}
                                    className="block rounded-lg px-3 py-2 typo-base font-medium text-gray-600 hover:bg-gray-50 hover:text-blue-600 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-blue-400 transition-colors"
                            ...
                            <a
                                href="#quick-start"
                                className="block rounded-lg px-3 py-2 typo-base font-semibold text-blue-600 hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-blue-950/20 transition-colors"
                                onClick={() => setMobileMenuOpen(false)}
                            >
                                Get Started
                            </a>
